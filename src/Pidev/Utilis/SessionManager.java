...
public class SessionManager {
   private static SessionManager instance;
    ...
    private static List<Integer> listoffre;
    ...
    SessionManager.roles=role;
      ...
      public SessionManager( ObservableList<Offre> offres) {
    

    // Initialiser la liste d'offres
    List<Integer> listOffres = new ArrayList<>();
    for (Offre offre : offres) {
        listOffres.add(offre.getId());
    }
    SessionManager.listoffre = listOffres;
}
    ...
    public static SessionManager getInstance() {
        ...
        public static SessionManager getInstance(ObservableList<Offre>  listoffre) {
            if(instance == null) {
            instance = new SessionManager( listoffre);
        }
        return instance;
    }
    ...
    public static List<Integer> getListoffre() {
        return listoffre;
    }

    public static void setListoffre(List<Integer> listoffre) {
        SessionManager.listoffre = listoffre;
    }
