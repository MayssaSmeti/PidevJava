 ...
 * @author msi
 */
public class LiReponse1Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        List<Pidev.Entities.Reponse> reponses = re.afficherReponsesByUser(currentRe);
    ...
    private void updateDisplayedReponse(String newValue) {
        ...
        List<Pidev.Entities.Reponse> reponses = re.afficherReponses().stream()
    ...
    private void trie(ActionEvent event) {
        ...
        List<Pidev.Entities.Reponse> reponses = reponseCRUD.afficherReponses();
    ...
    private void show(List<Pidev.Entities.Reponse> reponses) {
        // Supprimer les anciens éléments de la liste
        offreListContainer.getChildren().clear();
