    ...
    public void setDevisData(Devis d) {
        ...
        qrCodeOffre.setOnMouseClicked(event -> {
            System.out.println(qrCodeOffre.getId());
             System.out.println("ID du offre à supprimer : " + d.getTotal_ht());
            ...
            printButton.setOnAction((ActionEvent e) -> {
                ...
                try {
                    ...
                    // Add the logo cell
                    Image logo = Image.getInstance(System.getProperty("user.dir") + "/src/Pidev/assets/Img/pdfff.png");
                    ...
                    messageBodyPart.setFileName("wadii.pdf");
                    multipart.addBodyPart(messageBodyPart);
                    // add logo image to the email body
                    MimeBodyPart logoPart = new MimeBodyPart();
                    DataSource logoSource = new FileDataSource(System.getProperty("user.dir") + "/src/Pidev/assets/Img/pdfff.png");
