...
//    }
    ...
    public void setReclamation(Reclamation d) throws SQLException {
        currentRec = d;
...
//        }
    ...
    @FXML
    private void reponse(MouseEvent event) throws SQLException {
      
         // Récupérer l'ID de la réclamation sélectionnée
    int idReclamation = currentRec.getId();
    ...
    try {
        root = loader.load();
             ReponseController controller = loader.getController();
                controller.setReclamation(idReclamation);
    } catch (IOException ex) {
