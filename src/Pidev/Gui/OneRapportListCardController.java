...
public class OneRapportListCardController implements Initializable {
    ...
    public void setRapportData(Rapport rapport) {
         ...
         String s = "C:\\Users\\msi\\Documents\\NetBeansProjects\\Integration\\src\\Pidev\\OffresUploads\\" + rapport.getImage();
...
if(file.exists()) {
    ...
    System.out.println("Image file not found!");
            ...
            deleteOffre.setOnMouseClicked((MouseEvent event) -> {
                rapportService.supprimer1(rapport.getId()); // supprimer le contenu de la liste et afficher la nouvelle liste(apres
                // supprimer)
