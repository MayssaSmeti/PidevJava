 ...
 * @author msi
 */
public class OneReclamationListController implements Initializable {
    ...
    void setReclamationData(Reclamation reclamation) {
        ...
        detailsOffre.setOnMouseClicked(event -> {
            ...
            try {
                ...
                DetailsWindowController detailsController = loader.getController();
                detailsController.setTextDescription(description.getText());
                detailsController.setTextObjet(objet.getText());
                detailsController.setTextNote(note.getText());
            
                detailsController.setReclamation(currentRec);
