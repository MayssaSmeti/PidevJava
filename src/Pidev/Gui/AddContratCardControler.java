...
*/
        ...
        List<User> users = userService.afficherUtilisateurs();
        ...
        // Instancier le service de categorie
        VehiculeCRUD vehiculeService = new VehiculeCRUD();

        // Récupérer toutes les categories
        List<Vehicule> vehicules = vehiculeService.afficherVehicules();
