...
public class DevisItem {
    ...
    public DevisItem(int selectedDevisItemId, String description, int quantity, double price) {
        this.id = selectedDevisItemId;
        this.qte = quantity;
        this.description = description;
    ...
    public DevisItem(String description, int quantity, double price, Devis devis) {
    ...
    public DevisItem(int id, int qte, String description, double unitprice, Devis devis) {
        this.id = id;
        this.qte = qte;
        this.description = description;
        this.unitprice = unitprice;
